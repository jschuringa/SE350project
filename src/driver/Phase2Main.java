...
import messages.MarketMessageFactory;
...
public class Phase2Main {
    ...
    private static void testMessagePublisher() {
        ...
        try {
            ...
            MessagePublisher.getInstance().publishMarketMessage(MarketMessageFactory.makeMarketMessage(MarketState.PREOPEN));
            System.out.println(); 
            ...
            MessagePublisher.getInstance().publishMarketMessage(MarketMessageFactory.makeMarketMessage(MarketState.CLOSED));
